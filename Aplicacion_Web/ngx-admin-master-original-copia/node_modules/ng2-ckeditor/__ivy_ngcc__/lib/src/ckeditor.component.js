...
var CKEditorComponent = /** @class */ (function () {
    ...
    CKEditorComponent = CKEditorComponent_1 = __decorate([ __metadata("design:paramtypes", [core_1.NgZone])
    ], CKEditorComponent);
...
CKEditorComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CKEditorComponent, selectors: [["ckeditor"]], contentQueries: function CKEditorComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, ckbutton_directive_1.CKButtonDirective, false);
        ɵngcc0.ɵɵcontentQuery(dirIndex, ckgroup_directive_1.CKGroupDirective, false);
    } if (rf & 2) {
        var _t;
