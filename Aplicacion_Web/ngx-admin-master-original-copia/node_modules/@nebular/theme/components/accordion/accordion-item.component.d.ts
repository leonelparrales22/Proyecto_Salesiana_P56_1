...
export declare class NbAccordionItemComponent implements OnInit, OnChanges, OnDestroy {
    ...
    ngOnDestroy(): void;
    private invalidate;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<NbAccordionItemComponent>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NbAccordionItemComponent, "nb-accordion-item", never, {
    "collapsed": "collapsed";
    "expanded": "expanded";
    "disabled": "disabled";
}, {
