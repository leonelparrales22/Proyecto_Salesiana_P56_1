  ...
  <div id="main-wrapper">
    <div class="page-wrapper">
      <div class="container-fluid">
        ...
        <center class="m-t-30">
          <!-- <img src="../assets/img/cajero.png" class="img-circle" width="300" /> -->
          <div class="fondo2"></div>
          <br />
          <br />
          <h4 class="card-title m-t-10 subtitulo">
            Administrador: {{ this.$parent.cedula }}
          </h4>
        </center>
